...
dx run app-swiss-army-knife \
  ...
  -icmd="docker load -i quickdraws.tar && docker run  --security-opt seccomp=unconfined --gpus all --rm   --shm-size=16g -v ./:/mnt/ quickdraws quickdraws-step-1 --out /mnt/step1 --bed /mnt/genotype_antibody_only --batch_size 64 --lowmem --phenoFile /mnt/phenotypes_quantitative.tsv --covarFile /mnt/covariates_master.tsv --kinship /mnt/kinship.txt --chunksize 1024 --rhe_random_vectors 150 && tar -cvf step1_output_quant.tar ./step1*" \
