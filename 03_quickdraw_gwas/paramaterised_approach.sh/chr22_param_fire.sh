dx run app-swiss-army-knife \
  ...
  -iin="QuickdrawsGWAS/chr22_imputed.bgen" \
  -iin="QuickdrawsGWAS/chr22_imputed.bgen.bgi" \
  -iin="QuickdrawsGWAS/chr22_imputed.sample" \
  ...
  -icmd="bash run_step2.sh 22 p2b" \
  --instance-type=mem1_ssd1_v2_x4  \
  --name="qd_step2_weighted_chr22_p2b_x4" \
  --priority=high \
  -y
